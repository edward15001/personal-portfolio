...
(() => {
    ...
    const renderAppSwitcher = () => {
        ...
        openWins.forEach((id) => {
            ...
            const iconHtml = document.querySelector(`.icon[data-open="${id}"] .glyph`)?.innerHTML ?? EXTRA_WINDOW_ICON[id] ?? '';
    ...
    function dockIconRect(id) {
        const item = document.querySelector(`.cs-apps-item[data-win-id="${id}"]`);
        const target = item ?? document.getElementById('cs-home');
        return target ? target.getBoundingClientRect() : null;
    }
    function transformDeltas(from, to) {
        return {
    ...
    if (desktopEl) {
        ...
        window.addEventListener('pointermove', (e) => {
            ...
            document.querySelectorAll('.cs-apps-item').forEach((itemEl) => {
    ...
    document.getElementById('trash-icon')?.addEventListener('click', () => {
        document.querySelectorAll('.cs-apps-item.selected').forEach((itemEl) => {
    ...
    document.querySelectorAll('[data-drag]').forEach((el) => {
        el.addEventListener('pointerdown', (e) => startDrag(e, el.dataset.drag ?? ''));
    });
    document.querySelectorAll('[data-resize]').forEach((el) => {
        el.addEventListener('pointerdown', (e) => startResize(e, el.dataset.resize ?? ''));
    });
    ...
    const PROJECTS = {
        safegram: {
            ...
            desc: 'Actúa como un vigilante silencioso: analiza cada mensaje en tiempo real y frena phishing, spam e ' +
            ...
            visualIdentity: [
                {
                    label: 'Principios',
                    text: 'Ciberseguridad que se ve como lo que es: un sistema de vigilancia. Tres principios lo sostienen: ' +
                ...
                {
                    label: 'Color',
                    text: 'Noche (#07090B) como fondo y texto pálido (#D5E8E1) para la lectura. Sobre esa base, el verde ' +
                ...
                },
                {
                    ...
                    text: 'Tipografía de terminal, no de marca: JetBrains Mono (con Fira Code de respaldo) en toda la UI, ' +
                ...
                },
                {
                    ...
                    text: 'No hay fotografía — SafeGram no muestra nada que no sea dato. El fondo es una retícula tipo ' +
                ...
                {
                    label: 'En vivo',
                    text: 'Así se ve hoy safe-gram.vercel.app: noche casi negra, un escudo verde que brilla suavemente, ' +
            ...
            creativeProcess: [
                {
                    label: 'El problema',
                    text: 'SafeGram nació de un hueco concreto: las PYMEs usan Telegram como canal interno y no pueden pagar ' +
                ...
                {
                    label: 'La decisión',
                    text: 'El diseño hereda esa discreción: las alertas llegan por DM a los administradores con todos los ' +
                ...
                {
                    label: 'El giro',
                    text: 'La primera versión buscó la privacidad total con una Raspberry Pi y un modelo local, pero la ' +
            ...
            devProcess: 'SafeGram empezó como un Trabajo Fin de Grado: un vigilante silencioso para PYMEs que usan ' +
        ...
        nutrovia: {
            ...
            desc: 'Democratiza el acceso a planes de salud personalizados. Analiza los parámetros físicos de cada ' +
            ...
            visualIdentity: [
                {
                    label: 'Principios',
                    text: 'Nutrición y entrenamiento personalizados, con el rigor de un laboratorio y el trato de alguien ' +
                ...
                {
                    label: 'Color',
                    text: 'Papel cálido (#F2EFE8) como fondo y tinta (#1B1A17) para texto y filetes. Sobre esa base, cuatro ' +
                ...
                },
                {
                    ...
                    text: 'Newsreader Light 300, con su itálica, para las voces de marca — titulares y frases de portada, ' +
                ...
                },
                {
                    ...
                    text: 'La fotografía es siempre en blanco y negro, con luz natural lateral y gesto real — el color de ' +
            ...
            creativeProcess: [
                {
                    label: 'Antes',
                    text: 'La dirección anterior era oro sobre negro: fondo #0a0a0a, acentos #c9a84c, Outfit con un toque ' +
                        'de Fraunces itálica sobre una foto de stock oscurecida — elegante, pero genérico.',
                },
                {
                    label: 'Después',
                    text: 'La portada se reconstruyó sobre el sistema nuevo: papel cálido, una sola voz cromática verde y ' +
            ...
            devProcess: 'Backend Express + Node con PostgreSQL (Supabase vía pooler) y un frontend HTML/CSS/JS servido ' +
        ...
        angular: {
            ...
            desc: 'Un showcase de Angular diseñado como herramienta funcional y como lienzo técnico: flujos de trabajo ' +
            ...
            visualIdentity: [
                {
                    label: 'Principios',
                    text: 'Una vitrina técnica, no un producto de consumo: fondo casi negro (#000000) para que las tarjetas ' +
                ...
                {
                    label: 'Superficie',
                    text: 'Detrás de cada tarjeta hay una nebulosa animada: cuatro gradientes radiales — cian, magenta, ' +
                ...
                {
                    label: 'Tipografía',
                    text: 'Instrument Sans en negrita para los titulares (de 3rem en h1 a 1rem en h6) y JetBrains Mono para ' +
                ...
                },
                {
                    ...
                    text: 'El tema claro existe pero es secundario: cambia fondos y sombras a una paleta clara, sin tocar ' +
            ...
            creativeProcess: [
                {
                    label: 'El encargo',
                    text: 'Angular Task Manager nació como material de una presentación técnica sobre Angular moderno ' +
                        '(v17+): Standalone Components, Signals, el nuevo control de flujo (`@if`, `@for`) y Signal-based ' +
                        'Effects.',
                },
                {
                    label: 'La decisión',
                    text: 'El reto creativo era evitar que se viera como "otro starter de Angular" — con el rojo de marca y ' +
            ...
            devProcess: 'Cada pantalla es un Standalone Component (`LoginComponent`, `DashboardComponent`, `TaskListComponent`, ' +
        ...
        mandelbrot: {
            ...
            desc: 'Compara estrategias de programación concurrente y paralela frente a una carga intensiva de CPU. Un ' +
            ...
            visualIdentity: [
                {
                    label: 'La fórmula',
                    text: 'Aquí no hay diseñador: el algoritmo es la identidad visual. `colorFromIterations()` pinta cada ' +
                ...
                {
                    label: 'El degradado',
                    text: 'Ese degradado cuenta el coste real de cada píxel: azul puro (0,0,255) es donde la órbita escapa ' +
                ...
                {
                    label: 'El coste',
                    text: 'El negro y el rojo marcan justo donde el programa trabaja más: el interior nunca escapa y agota ' +
                ...
                {
                    label: 'Sin marca',
                    text: 'Sin tipografía de marca ni logo: la salida son PNGs (`BufferedImage.TYPE_INT_RGB`) y una tabla de ' +
            ...
            creativeProcess: [
                {
                    label: 'El reto',
                    text: 'Nació como práctica de una asignatura de Programación Concurrente y Paralela: el reto era ' +
                ...
                },
                {
                    ...
                    text: 'La identidad del proyecto no es de marca, es metodológica: la misma función de color en las tres ' +
            ...
            devProcess: 'Tres renderizadores comparten la misma función pura `MandelbrotCalculator.iterationsForPoint()`, así ' +
        ...
        buscaminas: {
            ...
            desc: 'El Buscaminas de siempre, pero vestido como un terminal de hacking competitivo: dos jugadores en ' +
            ...
            visualIdentity: [
                {
                    label: 'Principios',
                    text: 'El clásico reinterpretado como terminal de hacking competitivo: fondo casi negro (#111111), ' +
                ...
                },
                {
                    ...
                    text: 'Bordes de 1px sin redondear en botones, campos y tablas — nada de esquinas suaves — y ' +
                ...
                },
                {
                    ...
                    text: 'Todo en `Monospaced`, de la pantalla de login a la tabla de ranking, porque la ambición no es un ' +
                ...
                {
                    label: 'La cuadrícula',
                    text: 'El único adorno es funcional: la cuadrícula usa el verde atenuado (#556611) para las líneas y el ' +
            ...
            creativeProcess: [
                {
                    label: 'La pregunta',
                    text: 'La idea de partida era la más simple posible — el Buscaminas de siempre, hecho en Swing para ' +
                ...
                },
                {
                    ...
                    text: 'Lo que sí es real es la infraestructura detrás de la fantasía: cuentas de usuario, contraseñas ' +
            ...
            devProcess: 'MVC ligero sobre Java Swing + Maven: `model/` (User, Game), `dao/` (UserDAO, GameDAO sobre JDBC), ' +
    ...
    function renderProjectContent(p) {
        const gallery = p.images
            ...
            .join('');
        const links = (p.live ? `<a href="${p.live}" target="_blank" rel="noopener">Ver en vivo &nearr;</a>` : '') +
        ...
        const specList = (items) => `<div class="spec-list">${items
            .map((it) => `
        <div class="spec-row">
    ...
    function switchTab(name, opts = {}) {
        ...
        if (addrText)
            addrText.textContent = `eduardo.os/proyectos/${name}.exe`;
        ...
        const apply = () => {
            ...
            if (bar)
                window.setTimeout(() => { bar.style.width = '0%'; }, 200);
        };
        if (opts.fast)
            apply();
        else
